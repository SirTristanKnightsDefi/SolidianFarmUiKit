...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/SoIidian",
    },
];
var MENU_HEIGHT = 64;
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null, solidPriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/", target: "_blank" },
            React.createElement("img", { src: "https://ipfs.io/ipfs/Qmey8kWdYJEj5VSQqBqj2aAkga9tzEZKk8ddCAmDSTDDot?filename=shilling.svg", alt: "SHILLING Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } }),
            React.createElement(Text, { color: "textSubtle", bold: true }, "$" + solidPriceUsd.toFixed(8)))) : (React.createElement(Skeleton, { width: 80, height: 24 },
            React.createElement("img", { src: "https://ipfs.io/ipfs/Qmey8kWdYJEj5VSQqBqj2aAkga9tzEZKk8ddCAmDSTDDot?filename=shilling.svg", alt: "SHILLING Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } })))),
        React.createElement(SocialEntry, null, xsolidPriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/0x2F0D21f1B84F03fB9D60004fc206C86Be6902a32", target: "_blank" },
            ...
            React.createElement(Text, { color: "textSubtle", bold: true }, "$" + xsolidPriceUsd.toFixed(5)))) : (React.createElement(Skeleton, { width: 80, height: 24 },
            React.createElement("img", { src: "https://ipfs.io/ipfs/QmSMJy9D5MXrWsKDuZLrJNoxH5Rp55mSpAUzu48zFhjYfr?filename=squire.png", alt: "SQUIRE Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } })))),
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, solidPriceUsd: solidPriceUsd, xsolidPriceUsd: xsolidPriceUsd, pushNav: setIsPushed, links: links }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f1f6f8", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeeee", tertiary: "#EFF4F5", text: "#5f7888", textDisabled: "#BDC2C4", textSubtle: "#3868b5", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #fa3d7b 0%, #e9b965 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#703ddb", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", card: "#27262c", gradients: {
        bubblegum: "linear-gradient(139.73deg, #fa3d7b 0%, #e9b965 100%)",
    } });
